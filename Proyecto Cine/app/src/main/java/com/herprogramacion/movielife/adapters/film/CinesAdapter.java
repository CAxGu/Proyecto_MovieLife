...
//import java.util.List;
//
//public class CinesAdapter
//        extends RecyclerView.Adapter<CinesAdapter.ViewHolder>implements ItemClickListener {
//
//    private final Context context;
...
//        viewHolder.direcc.setText(cines.getAdress());
//        Glide.with(viewHolder.itemView.getContext())
...
//        public ViewHolder(View v,ItemClickListener listener) {
//            super(v);
//            direcc = (TextView) v.findViewById(R.id.cine_extradata);
